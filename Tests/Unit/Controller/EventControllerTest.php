<?php
namespace CGB\Relax5event\Tests\Unit\Controller;
...
{
    /**
     * @var \CGB\Relax5event\Controller\EventController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\CGB\Relax5event\Controller\EventController::class)
    ...
    public function listActionFetchesAllEventsFromRepositoryAndAssignsThemToView()
    {
        ...
        $eventRepository = $this->getMockBuilder(\CGB\Relax5event\Domain\Repository\EventRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $event = new \CGB\Relax5event\Domain\Model\Event();
